...
public class GoodsServiceImpl implements GoodsService {
    ...
    public Map queryGoodsById(Integer id) {
        ...
        goods_attributeExample.createCriteria().andGoodsIdEqualTo(id);
        ...
        goods_productExample.createCriteria().andGoodsIdEqualTo(id);
        ...
        goods_specificationExample.createCriteria().andGoodsIdEqualTo(id);
    ...
    public boolean updateGoods(AddGoods addGoods) {
        ...
        for (Goods_specification specification : specifications) {
            if (specification.getId()==null||specification.getId()==0){
                ...
                goods_specificationMapper.updateByPrimaryKeySelective(specification);
            }
        }
        ...
        for (Goods_attribute attribute : addGoods.getAttributes()) {
            if (attribute.getId()==null||attribute.getId()==0){
                ...
                goods_attributeMapper.updateByPrimaryKeySelective(attribute);
            }
        }
